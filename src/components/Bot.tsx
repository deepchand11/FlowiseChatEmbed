...
// I am an **Artificial Intelligence (AI) chatbot**, here to assist you with frequently asked questions you may have on the MyMaths product.

// As a non-human AI, I can provide responses and information based on description of RAG content. Please note that while I aim to be as helpful and accurate as possible, my responses are generated by algorithms and may not always be accurate.

// If I am unable to answer your questions satisfactorily, I can connect you with a human representative during business hours.

const mymathsWelcomeMessage = [
  {
    message:
      'I am an **Artificial Intelligence (AI) chatbot**, here to assist you with frequently asked questions you may have on the MyMaths product.',
    type: 'apiMessage',
  ...
  {
    message: 'If I am unable to answer your questions satisfactorily, I can connect you with a human representative during business hours.',
    type: 'apiMessage',
  },
];
...
export const Bot = (botProps: BotProps & { class?: string }) => {
  ...
  // As a non-human AI, I can provide responses and information based on the MyMaths help and support documentation. Please note that while I aim to be as helpful and accurate as possible, my responses are generated by algorithms and may not always be accurate.

  // If I am unable to answer your questions satisfactorily, I can connect you with a OUP Customer Service representative during business hours.
